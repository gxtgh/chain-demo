...
export const zhCnMessages = {
  ...
  tokenDividendCreation: {
    ...
    tooltips: {
      ...
      fundAddress: '接收营销税率的钱包地址；留空时默认使用当前连接钱包地址。',
      minHoldingForDividend: '持有超过此数量才能获得分红。',
      dividendTriggerThreshold: '达到此代币数量阈值时触发分红分发。',
      autoProcessGasLimit: '自动分发时允许使用的最大 Gas 限制。',
      killBlockCount: '手动开放交易后前若干区块可执行特殊防护逻辑。',
      mintEnabled: '开启后可增发项目代币，选择关闭后无法更改。',
    ...
    overview: {
      ...
      cards: {
        dividendModes: {
          title: '分红模式',
          description: '支持本币分红和其他代币分红，两种模式共用同一套创建结构和后续控制逻辑。',
        },
        taxFlow: {
          title: '税率流向',
    ...
    nextSteps: {
      ...
      verifyRoute: {
        title: '验证分红路径',
        description: '尤其是其他代币分红模式，需要确认奖励币换币路径和分红逻辑都能按预期执行。',
      },
  ...
  tokenManage: {
    eyebrow: '',
    title: '代币管理',
    description: '代币管理控制台，集中查看代币基础信息、税率结构、权限状态与链上配置，支持对白名单、黑名单、增发、分红设置、流动性控制及关键权限进行统一管理与操作。',
    seo: {
      title: '{{chain}} 代币管理 | 分红代币维护与参数操作',
      description: '读取 {{chain}} 上的代币状态，查看分红参数、名单和权限，并继续执行代币管理操作。',
      keywords: '{{chain}} 代币管理, 分红代币管理, Token Manage Console, Token Dashboard',
    },
    search: {
      label: '代币合约',
      tooltip: '请输入要管理的代币合约地址。当前页面会优先按分红代币类型进行识别。',
      placeholder: '请输入代币合约',
      load: '加载代币'
    },
    empty: {
      title: '先加载一个代币',
      description: '输入合约地址后，控制台会展示代币信息、参数概览和对应的操作区。',
    },
    loading: '正在读取代币链上状态...',
    header: {
    ...
    sections: {
      supplyDividend: {
        title: '供应与分红',
        description: '围绕增发、分红阈值、自动处理 gas 和手动分红的核心操作。',
      },
      listsPermissions: {
        title: '名单与权限',
    ...
    actions: {
      ...
      whitelist: {
        ...
        protectedNotice: '当前白名单中有 {{count}} 个系统保护地址，不建议移除。',
      },
      blacklist: {
        title: '黑名单权限',
      ...
      trading: {
        ...
        manualTradingDisabled: '当前代币未启用手动开放交易模式，不能在这里手动开启交易。',
      },
    },
    danger: {
      warning: '危险操作',
