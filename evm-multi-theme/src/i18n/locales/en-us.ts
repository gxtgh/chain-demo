...
export const enUsMessages = {
  ...
  tokenDividendCreation: {
    ...
    description:
      'Create a {{tokenType}} dividend token on {{chain}} with same-token or external-token rewards, plus tax splits, thresholds, allowlists, and manual trading controls.',
    seo: {
      title: 'Create {{tokenType}} Dividend Token on {{chain}} | Same or External Reward Mode',
      description:
        'Launch a {{tokenType}} dividend token on {{chain}} with reward-mode selection, buy/sell/transfer tax splits, list controls, and trading setup fields.',
      keywords: 'Create Dividend Token, {{chain}} Dividend Token Creator, {{tokenType}} Dividend Token, Same Token Rewards, External Token Rewards',
    },
    fields: {
      name: 'Token Full Name',
      symbol: 'Token Symbol',
      ...
      poolToken: 'Paired Pool Token',
      dividendToken: 'Reward Token',
      isSameTokenDividend: 'Same-Token Reward Mode',
      receiveAddress: 'Initial Receiver Address',
      fundAddress: 'Fund Address',
      minHoldingForDividend: 'Minimum Reward Holding',
      dividendTriggerThreshold: 'Reward Trigger Threshold',
      autoProcessGasLimit: 'Auto-Process Gas',
      killBlockCount: 'Kill Block Count',
      mintEnabled: 'Enable Mint Permission',
      manualTradingEnable: 'Manual Trading Enable',
      whitelistEnabled: 'Enable Whitelist',
      blacklistEnabled: 'Enable Blacklist',
      initialWhitelist: 'Initial Whitelist Addresses',
      initialBlacklist: 'Initial Blacklist Addresses',
    },
    labels: {
      modeTitle: 'Reward Mode',
      modeDescription: 'Choose the reward asset and routing path first, then continue with thresholds, taxes, and permission controls.',
      sameTokenModeHelp: 'In same-token mode, the dividend portion of the tax flow is handled with the token itself as the reward asset.',
      externalTokenModeHelp: 'In external-token mode, the dividend portion is swapped through the selected router before distribution.',
      distributionRules: 'Distribution Parameters',
      distributionRulesNote: 'These settings define the initial receiver, fund address, minimum participation threshold, and processing intensity.',
      taxConfiguration: 'Tax Matrix',
      taxConfigurationNote: 'Taxes are configured separately for buy, sell, and transfer, and each category is split into fund, reflow, burn, and dividend portions.',
      totalTaxRate: 'Combined Tax Across All Categories',
      permissionControls: 'Permissions and Lists',
      permissionControlsNote: 'Use this section to decide whether minting stays available, trading opens manually, and whether blacklists or whitelists are enabled.',
      creationFee: 'Creation Fee',
    },
    modes: {
      sameToken: 'Same-Token Reward',
      externalToken: 'External-Token Reward',
    },
    taxGroups: {
      buy: 'Buy Taxes',
      sell: 'Sell Taxes',
    ...
    taxGroupDescriptions: {
      buy: 'Tax split applied during buy transactions.',
      sell: 'Tax split applied during sell transactions.',
      transfer: 'Tax split applied during direct token transfers.',
    },
    taxFields: {
      MarketingTax: 'Fund Tax',
      ReflowTax: 'Reflow Tax',
      BurnTax: 'Burn Tax',
      DividendTax: 'Dividend Tax',
    },
    taxTooltips: {
      MarketingTax: 'This portion is routed to the fund address.',
      ReflowTax: 'This portion is reserved for liquidity-facing or reflow logic.',
      BurnTax: 'This portion is routed to the burn direction in the contract flow.',
      DividendTax: 'This portion enters the dividend processing path.',
    },
    placeholders: {
      name: 'Please enter the token full name',
      symbol: 'Please enter the token symbol',
      totalSupply: 'Please enter the supply',
      decimals: 'Please enter the precision',
      exchange: 'Select an available factory and exchange',
      poolToken: 'Select or enter the paired token address',
      dividendToken: 'Select or enter the reward token address',
      receiveAddress: 'Leave empty to use the connected wallet',
      fundAddress: 'Leave empty to use the connected wallet',
      minHoldingForDividend: 'Enter the minimum holding for rewards',
      dividendTriggerThreshold: 'Enter the reward trigger threshold',
      autoProcessGasLimit: 'Enter the auto-process gas limit',
      killBlockCount: 'Enter the kill block count, default 0',
      initialWhitelist: 'One address per line, or separate entries with commas / semicolons',
      initialBlacklist: 'One address per line, or separate entries with commas / semicolons',
    },
    tooltips: {
      name: 'The full token name displayed in wallets, explorers, and trading interfaces.',
      symbol: 'The short token symbol, usually a compact letter or number combination.',
      totalSupply: 'The initial total supply. The contract applies decimals during deployment.',
      decimals: 'Defines the smallest divisible unit. In most cases, 18 is the recommended default.',
      exchange: 'Choose the dividend-token factory and router path that should be used for deployment.',
      poolToken: 'This token is used to build the main pair. If you choose the native coin, deployment automatically uses the wrapped version.',
      dividendToken: 'In external-token reward mode, this is the reward asset. If you choose the native coin, deployment automatically uses the wrapped version.',
      isSameTokenDividend: 'Turn this on for same-token rewards. Turn it off to select a separate reward token.',
      receiveAddress: 'The initial token receiver. If left empty, the connected wallet is used.',
      fundAddress: 'The fund address. If left empty, the connected wallet is used.',
      minHoldingForDividend: 'Only holders above this threshold are eligible for reward processing.',
      dividendTriggerThreshold: 'The contract starts reward processing only after the pending amount reaches this threshold.',
      autoProcessGasLimit: 'Maximum gas that automatic reward processing can spend.',
      killBlockCount: 'Protection logic can apply during the first blocks after manual trading is opened.',
      mintEnabled: 'If enabled, the owner can still mint later from the console.',
      manualTradingEnable: 'If enabled, trading must be opened manually after deployment.',
      whitelistEnabled: 'Turn on the whitelist mechanism at deployment time.',
      blacklistEnabled: 'Turn on the blacklist mechanism at deployment time.',
      initialWhitelist: 'Addresses written into the whitelist during deployment.',
      initialBlacklist: 'Addresses written into the blacklist during deployment.',
      creationFee: 'The creation fee is read from the selected dividend-token factory. Network gas is charged separately on submission.',
    },
    actions: {
      submit: 'Create Dividend Token',
      submitting: 'Submitting...',
      close: 'Close',
      retry: 'Try Again',
    },
    status: {
      factoryUnavailable: 'No dividend-token factory is configured for the current chain yet.',
      searchingToken: 'Searching token metadata on-chain...',
      noTokenInfo: 'No token information found',
      emptyTokenList: 'No tokens available',
    },
    steps: {
      preparing: 'Prepare dividend-token parameters',
      waitingWallet: 'Please sign the transaction',
      pending: 'Dividend-token creation in progress',
      completed: 'Creation completed',
      failed: 'Creation failed',
    },
    errors: {
      ...
      supplyInvalid: 'Total supply must be a positive integer.',
      decimalsInvalid: 'Decimals must be between 0 and 18.',
      receiveAddressInvalid: 'Please enter a valid receiver address.',
      fundAddressInvalid: 'Please enter a valid fund address.',
      exchangeRequired: 'Select an available dividend-token factory.',
      poolTokenRequired: 'Select or enter the paired token.',
      dividendTokenRequired: 'A reward token is required in external-token mode.',
      dividendTokenInvalid: 'Please enter a valid reward-token address.',
      minHoldingInvalid: 'Enter a minimum reward holding greater than 0.',
      dividendTriggerThresholdInvalid: 'Enter a reward trigger threshold greater than 0.',
      autoProcessGasLimitInvalid: 'Auto-process gas must be an integer greater than 0.',
      killBlockInvalid: 'Kill block count must be an integer greater than or equal to 0.',
      addressListInvalid: 'The address list format is invalid. Please review each address.',
      taxValueInvalid: 'Each tax value must be between 0 and 25 with up to two decimal places.',
      taxCategoryExceeded: '{{type}} cannot exceed {{max}}% in total.',
      taxGrandTotalExceeded: 'The combined total across all tax categories cannot exceed {{max}}%.',
      valueMustBeLessThanSupply: 'This value must stay below the total token supply.',
      tokenLookupFailed: 'Token lookup failed. Please confirm the address is a valid ERC20 contract.',
      walletRequired: 'Connect a wallet before submitting.',
      walletUnavailable: 'Injected wallet was not found in this browser.',
      factoryUnavailable: 'Dividend-token factory is not configured for this chain.',
      insufficientBalance: 'Insufficient balance to cover gas and the creation fee.',
      factoryDeploymentFailed: 'Factory deployment failed. Please try again later.',
      receiveAddressRequired: 'Receiver address cannot be empty.',
      fundAddressRequired: 'Fund address cannot be empty.',
      fundAddressDead: 'The fund address cannot be the dead address.',
    },
    success: {
      banner: 'Dividend token created successfully',
      tokenAddress: 'Token Address',
      txHash: 'Transaction Hash',
    },
    successSummary: {
      title: 'Creation Summary',
      description: 'Your dividend token has been created successfully. Keep the deployment result and key parameters so you can continue into the management console later.',
      chain: 'Network',
      name: 'Token Name',
      symbol: 'Token Symbol',
      totalSupply: 'Total Supply',
      ...
      sellTax: 'Total Sell Tax',
      transferTax: 'Total Transfer Tax',
      exchange: 'Exchange',
    ...
    overview: {
      title: 'Dividend token overview',
      description: 'This {{tokenType}} dividend-token model is designed around a “deploy first, manage later” workflow, with support for multiple reward-asset modes and richer operating controls.',
      highlights: {
        mode: 'Dual reward modes',
        tax: 'Three-way tax matrix',
        reward: 'Switchable reward asset',
        manage: 'Ready for later console management',
      },
      cards: {
        dividendModes: {
          title: 'Reward Modes',
          description: 'Support both same-token rewards and external-token rewards under the same deployment structure and later management flow.',
        },
        taxFlow: {
          title: 'Tax Routing',
          description: 'Buy, sell, and transfer taxes can each be split into fund, reflow, burn, and dividend portions.',
        },
        management: {
          title: 'Post-Deployment Controls',
          description: 'After deployment, the token can move into a console flow for list management, parameter updates, manual reward processing, and permission handling.',
        },
      },
    },
    nextSteps: {
      title: 'Next Steps',
      description: 'After the dividend token is created, finish these steps to make the on-chain state and later operations easier to manage.',
      importWallet: {
        title: 'Import into Wallets and Explorers',
        description: 'Confirm that the token address, symbol, and decimals are displayed correctly for internal review and external visibility.',
      },
      addLiquidity: {
        title: 'Create the Pair and Add Liquidity',
        description: 'Build the main pair on the target DEX using the same pool token selected during creation, then add the initial liquidity.',
      },
      openConsole: {
        title: 'Move into the Console',
        description: 'After creation, continue into the management console to maintain taxes, reward processing, lists, and permissions.',
      },
      verifyRoute: {
        title: 'Validate the Reward Route',
        description: 'External-token reward mode especially requires validation that the reward swap path and distribution logic behave as expected.',
      },
      note: 'Display and sync timing may vary across chains, DEXs, and wallets. Always confirm against the live on-chain state and your own integration checks.',
    },
    modal: {
      progressTitle: 'Creating dividend token',
      successTitle: 'Dividend token created successfully',
      errorTitle: 'Dividend token creation failed',
    },
  },
  tokenVanityCreation: {
    eyebrow: '',
