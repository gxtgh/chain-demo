...
export const enUsMessages = {
  ...
  tokenDividendCreation: {
    ...
    tooltips: {
      ...
      fundAddress: 'The wallet that receives the marketing tax. If left empty, the connected wallet is used.',
      minHoldingForDividend: 'Holders only receive dividends after exceeding this amount.',
      dividendTriggerThreshold: 'Dividend distribution is triggered when this token threshold is reached.',
      autoProcessGasLimit: 'Maximum gas allowed for automatic dividend distribution.',
      killBlockCount: 'Protection logic can apply during the first blocks after manual trading is opened.',
      mintEnabled: 'If enabled, the project token can still be minted later and cannot be restored once disabled.',
  ...
  tokenManage: {
    ...
    description: 'Use the token management console to review core token info, tax structure, permissions, and on-chain settings, then manage lists, minting, dividend settings, liquidity controls, and key permissions in one place.',
    seo: {
      title: '{{chain}} Token Console | Dividend Token Maintenance',
      description: 'Read token state on {{chain}}, inspect dividend parameters, lists, and permissions, and continue with grouped console operations.',
      keywords: '{{chain}} token console, dividend token management, token manage console, token dashboard',
    },
    search: {
      label: 'Token Contract',
      tooltip: 'Enter the token contract address you want to manage. The current page first tries to identify the token as a dividend-token contract.',
      placeholder: 'Enter the token contract',
      load: 'Load Token'
    },
    empty: {
      title: 'Load a token first',
      description: 'After you enter a contract address, the console will show the token header, overview cards, and grouped operation sections.',
    },
    ...
    sections: {
      supplyDividend: {
        title: 'Supply & Dividends',
        description: 'Core actions for minting, dividend thresholds, automatic gas, and manual dividend processing.',
      },
      listsPermissions: {
    ...
    actions: {
      ...
      thresholds: {
        ...
        manualProcess: 'Pending Pool Dividends',
      ...
      whitelist: {
        ...
        protectedNotice: 'There are {{count}} protected system addresses in the current whitelist.',
      },
      blacklist: {
