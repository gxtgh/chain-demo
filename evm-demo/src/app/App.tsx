...
import { CustomMessageTransferPage } from '../pages/custom-message-transfer-page'
  ...
  return (
    <Routes>
      ...
      <Route element={<AppShell />}>
        ...
        <Route path="/custom-message-transfer/:chain/:lang" element={<CustomMessageTransferPage />} />
      </Route>
      <Route path="*" element={<Navigate to="/create-token/bsc/en-us" replace />} />
    </Routes>
  )
